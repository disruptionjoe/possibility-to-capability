...
Files: report subject fixture `./tests/condition2prime_constructive_probe.py` (commit `a193a3b`, verified); referee probe `<local-scratchpad>/referee_probe_2prime_construct.py` (counterexample and re-derivations, all outputs quoted above).